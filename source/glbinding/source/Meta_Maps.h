...
extern const std::unordered_map<std::string, std::string> Meta_CategoryByFunction;
extern const std::unordered_map<std::string, std::list<std::string>> Meta_FunctionsByCategory;
